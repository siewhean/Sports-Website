...
import { acquirePlaywrightSharedPortLock, acquirePlaywrightWorktreeLock } from "./playwright-worktree-lock.mjs";

const releaseWorktree = acquirePlaywrightWorktreeLock(process.cwd());
...
let releasePorts;
try {
  releasePorts = acquirePlaywrightSharedPortLock(process.cwd());
