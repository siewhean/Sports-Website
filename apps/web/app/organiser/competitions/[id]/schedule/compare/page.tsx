...
export default async function ScheduleComparePage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ left?: string; right?: string }> }) {
  ...
  return <OrganiserWorkspace competition={result.competition} section={phase4ScheduleMachine.section} sectionAction={null} pageTitle={phase4ScheduleCopy.compare} pageIntro={phase4ScheduleCopy.selectTwoBody} pageEyebrow={phase4ScheduleCopy.immutableDiff} syncLabel={phase4ScheduleCopy.saved} syncState={phase4ScheduleMachine.saved} sectionContent={<ScheduleRevisionComparison document={document} left={left} right={right} />} />;
}
