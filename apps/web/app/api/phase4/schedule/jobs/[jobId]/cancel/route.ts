...
import { parseScheduleJobView, phase4ScheduleCopy, phase4ScheduleMachine } from "@/lib/phase4-schedule";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ jobId: string }> }) {
  ...
  return forwardPhase3Mutation(request, { method: phase4ScheduleMachine.post, path: `/api/v1/schedule-jobs/${encodeURIComponent(jobId)}/cancel`, body, validate: (value) => parseScheduleJobView(value, true) !== null });
}
