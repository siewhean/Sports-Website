...
export const phase2Copy = {
  ...
  publicListIntro: "Every active competition. Live scores, schedules, and results.",
  publicListEmptyBody:
  ...
  resultsIntro: "Live standings and knockout decisions, updated each time a result is finalised.",
  publishTitle: "Publication",
  publishIntro:
    "Each published revision is a permanent public snapshot. Open a new draft to update the schedule or results.",
  accessTitle: "Scoring access",
  accessIntro:
    "Issue a scoring pass for each match. Each pass is tied to one fixture, limited to one active scorer at a time, and can be revoked instantly.",
  ...
  controlIntro: "Your live match status, what's coming up next, and whether the published competition is up to date.",
  ...
  finalisationNotReady: "This match is not ready to finalise. Complete the required periods or games, resolve any scoring conflicts, then try again.",
