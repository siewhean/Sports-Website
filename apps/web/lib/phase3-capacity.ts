...
export const phase3CapacityCopy = {
  ...
  crossMidnightHint: "Use this only when the end time is after midnight, for example 22:00 to 02:00.",
  crossMidnightSelected: "This window will end on the following calendar day.",
  save: "Save capacity",
  saving: "Saving…",
