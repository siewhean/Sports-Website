...
const Recommendation = strict({
  id: Type.String({ minLength: 1, maxLength: 128 }),
  format_revision_id: Type.Union([Type.Null(), Id]),
  ...
  guaranteed_matches: Type.Integer({ minimum: 1 }),
  ranking_coverage: Type.Union([Type.Literal("all_entries"), Type.Literal("podium"), Type.Literal("champion")]),
  available_match_slots: Type.Integer({ minimum: 0 }),
  division_formats: Type.Array(
    strict({
      division_id: Id,
      candidate_division_id: Id,
      format_revision_id: Type.Union([Type.Null(), Id]),
      format_definition_hash: Hash,
      match_count: Type.Integer({ minimum: 1 }),
      guaranteed_matches: Type.Integer({ minimum: 1 }),
