      ...
      recommendations: [
        {
          ...
          divisionFormats: [
            {
              divisionId: "division-1",
              candidateDivisionId: "candidate-1",
              formatRevisionId: "format-revision-1",
              definitionHash: "format-a",
              matchCount: 24,
              guaranteedMatches: 3,
        ...
        },
        {
          ...
          guaranteedMatches: 2,
          rankingCoverage: "podium",
          availableMatchSlots: 40,
          divisionFormats: [
            {
              divisionId: "division-1",
              candidateDivisionId: "candidate-2",
              formatRevisionId: "format-revision-2",
              definitionHash: "format-b",
              matchCount: 18,
              guaranteedMatches: 2,
...
describe("Phase 4 Assisted Setup validation", () => {
  ...
  it("caps normal recommendations and requires feasible acknowledged selection", () => {
    ...
    const options = Array.from({ length: 4 }, (_, index) => ({
      ...
      minimumMatchesPerEntry: 2,
      guaranteedMatches: 2,
      rankingCoverage: "podium" as const,
      availableMatchSlots: 40,
      divisionFormats: [
        {
          divisionId: "division-1",
          candidateDivisionId: `candidate-${index}`,
          formatRevisionId: `format-revision-${index}`,
          definitionHash: `hash-${index}`,
          matchCount: 16 + index,
          guaranteedMatches: 2,
    ...
    const values = {
      ...
      format_recommendations: {
        ...
        requiresChanges: {
          ...
          guaranteedMatches: 4,
          rankingCoverage: "all_entries" as const,
          availableMatchSlots: 40,
          divisionFormats: [
            {
              divisionId: "division-1",
              candidateDivisionId: "candidate-over",
              formatRevisionId: "format-revision-over",
              definitionHash: "over-hash",
              matchCount: 48,
              guaranteedMatches: 4,
