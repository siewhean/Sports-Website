...
describeInfrastructure("Phase 4 Assisted Setup upgrade safety", () => {
  ...
  it("fails closed when the selected sport has no valid active pack", async () => {
  ...
  it("upgrades populated pre-0014 setup and template data through the real migrator", async () => {
  ...
  it("rejects a populated pre-0014 cross-sport template application", async () => {
