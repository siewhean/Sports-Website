...
async function createWorld(): Promise<World> {
  ...
  await sql`
    INSERT INTO scoring_access_passes (
      ...
      (${passA}, ${competitionA}, ${matchA}, ${randomBytes(32)}, ${randomBytes(32)}, 'hmac_sha256_v1', '2100-08-01T12:00:00Z', ${accountA}),
      (${passB}, ${competitionB}, ${matchB}, ${randomBytes(32)}, ${randomBytes(32)}, 'hmac_sha256_v1', '2100-08-02T12:00:00Z', ${accountB})
  `;
  ...
  it("enforces exact role scopes while allowing multiple generation-free viewers", async () => {
    ...
    await expect(sql`
      INSERT INTO scoring_access_passes (
        ...
        '2100-08-01T12:00:00Z', ${world.accountA}
      )
    `).rejects.toThrow();
    await sql`
      INSERT INTO scoring_access_passes (
